...
get_header(); ?>
    <div class="hero">
        <!-- PROMO SLIDE -->
        <?PHP /* ?> 
        <div class="slide1 slide" style="position: absolute; top: 0; left: 0; z-index: 2; background-image: url(<?php bloginfo('template_url'); ?>/images/heros/hero12112015.jpg); background-color: #fff;">
